...
export const StorePage: React.FC<StorePageProps> = ({ currentPath = "/loja", setCurrentPath }) => {
  ...
  return (
    <div className="min-h-screen bg-[#050508] text-white pb-32 pt-8">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8 space-y-10">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="relative w-full md:w-96">
              ...
              <input
                ...
                className="w-full bg-[#0B0B0E] border border-[#22222E] rounded-xl pl-10 pr-4 py-3 text-xs text-white placeholder-zinc-500 outline-none focus:border-[#FF8A00] transition-all shadow-inner"
              />
              {searchTerm && (
                <button
            ...
            <button
              ...
              className={`px-4 py-2.5 rounded-xl text-xs font-black uppercase tracking-wider transition-all whitespace-nowrap shrink-0 cursor-pointer ${
                selectedCategory === "Todos"
                  ? "bg-gradient-to-r from-[#FF8A00] to-[#FF6200] text-[#070709] shadow-md shadow-[#FF8A00]/20 font-montserrat"
                  : "bg-[#0E0E14] text-zinc-400 hover:text-white border border-zinc-800"
              }`}
            >
              🔥 Todos
            </button>
          ...
          <section className="space-y-4">
            <div className="flex items-center justify-between border-b border-zinc-800/80 pb-3">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-lg font-black uppercase tracking-tight font-montserrat text-white">
                  Destaques da Semana
                </h2>
              </div>
            </div>
        ...
        <section className="space-y-4">
          <div className="flex items-center justify-between border-b border-zinc-800/80 pb-3">
            <h2 className="text-lg font-black uppercase tracking-tight font-montserrat text-white flex items-center gap-2">
              <span>Vitrine de Equipamentos</span>
              {selectedCategory !== "Todos" && (
                <span className="text-[#FF8A00] text-sm">({selectedCategory})</span>
              )}
            </h2>
          </div>
          ...
          {loading ? (
            <div className="py-20 flex flex-col items-center justify-center text-center space-y-4">
              <RefreshCw className="w-8 h-8 text-[#FF8A00] animate-spin" />
            ...
            <div className="py-16 bg-[#0B0B0E] border border-zinc-800 rounded-3xl text-center p-8 space-y-3">
              ...
              <button
                ...
                className="px-5 py-2.5 bg-[#FF8A00] text-[#070709] font-black text-xs uppercase rounded-xl cursor-pointer"
              >
        ...
        {promoProducts.length > 0 && (
          <section className="relative rounded-3xl overflow-hidden bg-gradient-to-r from-[#181108] via-[#1F140A] to-[#0D0B08] border border-[#FF8A00]/40 p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-6 shadow-2xl">
            <div className="space-y-2 text-center sm:text-left">
              <span className="px-3 py-1 bg-[#FF8A00]/20 border border-[#FF8A00]/40 text-[#FFC247] text-[10px] font-black uppercase tracking-widest rounded-full inline-block">
                🔥 Ofertas Especiais
              </span>
              <h3 className="text-2xl sm:text-3xl font-black uppercase text-white font-montserrat">
            ...
            <button
              ...
              className="px-6 py-3.5 bg-gradient-to-r from-[#FF8A00] to-[#FF6200] hover:from-[#FFA333] hover:to-[#FF731A] text-[#070709] font-black text-xs uppercase tracking-widest rounded-2xl shadow-xl shadow-[#FF8A00]/25 transition-all active:scale-95 cursor-pointer shrink-0 font-montserrat flex items-center gap-2"
            >
